...
다시 쓸 결론은 `war_game/` · `linux_101/` · `gdb/` · `web_basics/` · `web_hacking/` · `security_awareness/` · `lecture/` 쪽으로 옮기는 편.
...
| [2026-08-08.md](2026-08-08.md) | Security Awareness Training Path 완료 |
